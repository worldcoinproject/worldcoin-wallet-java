...
public class WorldcoinWalletInfoTest extends TestCase {
    ...
    public void testRoundTrip() throws Exception {
        ...
        // create wallet info
        WalletInfoData walletInfo = new WalletInfoData(walletName, null, WorldcoinWalletVersion.SERIALIZED);
        ...
        // write to file
        walletInfo.writeToFile(WalletInfoData.createWalletInfoFilename(walletName), WorldcoinWalletVersion.SERIALIZED);
        ...
        WalletInfoData rebornWalletInfo = new WalletInfoData(walletName, null, WorldcoinWalletVersion.SERIALIZED);
    ...
    public void testloadNonExistentInfoFile() throws Exception {
        ...
        WalletInfoData walletInfo = new WalletInfoData(walletName, null, WorldcoinWalletVersion.PROTOBUF);
        assertNotNull(walletInfo);
    }
