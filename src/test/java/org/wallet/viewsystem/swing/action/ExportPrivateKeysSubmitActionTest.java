...
import org.wallet.controller.WorldcoinControllerTest;
import org.wallet.controller.SimpleWalletBusyListener;
...
public class ExportPrivateKeysSubmitActionTest extends TestCase {   
    ...
    public void testExportPrivateKeysWithNonEncryptedWallet() throws Exception { 
        ...
        assertTrue("WorldcoinWallet password is enabled when it should not be", !exportPanel.isWalletPasswordFieldEnabled());
        ...
        WorldcoinControllerTest.waitForWalletNotBusy(walletBusyListener);
    ...
    public void testExportPrivateKeysWithEncryptedWallet() throws Exception { 
        ...
        assertNotNull("exportAction was not created successfully", exportAction);
        assertEquals("Wrong number of keys at wallet creation", 1, controller.getModel().getActiveWallet().getKeychain().size());
        assertTrue("WorldcoinWallet password is not enabled when it should be", exportPanel.isWalletPasswordFieldEnabled());
