...
public class CreateNewReceivingAddressSubmitActionTest extends TestCase {      
    ...
    public void testAddReceivingAddressesWithEncryptedWallet() throws Exception {   
        ...
        assertTrue("WorldcoinWallet password is not enabled when it should be", createNewPanel.isWalletPasswordFieldEnabled());
        ...
        assertTrue("WorldcoinWallet is not encrypted but it should be", controller.getModel().getActiveWallet().getEncryptionType() == EncryptionType.ENCRYPTED_SCRYPT_AES);
