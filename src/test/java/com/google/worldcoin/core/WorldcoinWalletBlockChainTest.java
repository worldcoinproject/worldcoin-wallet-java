...
import static com.google.worldcoin.core.CoreTestUtils.createFakeBlock;
import static com.google.worldcoin.core.CoreTestUtils.createFakeTx;
import static org.junit.Assert.*;

// Handling of chain splits/reorgs are in ChainSplitTests.

public class WorldcoinWalletBlockChainTest {
    ...
    public void setUp() throws Exception {
        ...
        wallet = new Wallet(unitTestParams) {
            ...
            public void receiveFromBlock(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType, int relativityOffset) throws VerificationException {
                ...
                WorldcoinWalletBlockChainTest.this.block[0] = block;
                if (tx.isCoinBase()) {
                    WorldcoinWalletBlockChainTest.this.coinbaseTransaction = tx;
                 }
            }
        };
    ...
    public void duplicates() throws Exception {
        ...
        assertTrue(chain.add(b2));
        assertEquals(b3, chain.getChainHead().getHeader());
        // WorldcoinWallet was NOT called with the new block because the duplicate add was spotted.
        assertEquals(b3, block[0].getHeader());
    }
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        for (int i = 0; i < unitTestParams.getSpendableCoinbaseDepth() - 2; i++) {
            ...
            // WorldcoinWallet still does not have the coinbase transaction available for spend.
        ...
        // WorldcoinWallet now has the coinbase transaction available for spend.
