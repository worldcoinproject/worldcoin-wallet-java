...
/**
 * An interface describing a collection of views that are used to render the WorldcoinWallet application.
 * @author jim
 *
 */
public interface ViewSystem extends WalletEventListener { 
    ...
    /**
     * A method called when WorldcoinWallet online status changes between online, connecting. error.
     */
