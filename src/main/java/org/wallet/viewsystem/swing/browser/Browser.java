...
public class Browser extends javax.swing.JEditorPane {
    ...
    public Browser(Controller controller, WorldcoinWalletFrame mainFrame, String currentHref) {
        super();
        ...
        try {
            ...
            if (fontName == null || "".equals(fontName)) {
                fontName = ColorAndFontConstants.WORLDCOIN_WALLET_DEFAULT_FONT_NAME;
            }
