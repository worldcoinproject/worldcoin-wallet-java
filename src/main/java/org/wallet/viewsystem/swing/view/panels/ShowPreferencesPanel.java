...
public class ShowPreferencesPanel extends JPanel implements Viewable, PreferencesDataProvider {
    ...
    private WorldcoinWalletLabel fontNameTextLabel;
    private WorldcoinWalletLabel fontStyleTextLabel;
    private WorldcoinWalletLabel fontSizeTextLabel;

    private WorldcoinWalletLabel exchangeInformationLabel;

    private String originalFontName;
    private String originalFontStyle;
    private String originalFontSize;

    private WorldcoinWalletButton undoChangesButton;

    private String originalUserLanguageCode;

    private boolean originalShowTicker;
    private boolean originalShowWorldcoinConvertedToFiat;
    ...
    private JCheckBox showWorldcoinConvertedToFiat;
    ...
    private WorldcoinWalletLabel exchangeLabel2;
    private WorldcoinWalletLabel currencyLabel2;
    ...
    private WorldcoinWalletTextField oerApiCodeTextField;
    private String haveShownErrorMessageForApiCode;
    private WorldcoinWalletButton getOerAppIdButton;
    private WorldcoinWalletLabel oerApiCodeLabel;
    private WorldcoinWalletLabel oerMessageLabel1, oerMessageLabel2;
     ...
     */
    public ShowPreferencesPanel(WorldcoinController worldcoinController, ExchangeController exchangeController, WorldcoinWalletFrame mainFrame) {
    ...
    public void displayView(DisplayHint displayHint) {
        ...
        originalShowWorldcoinConvertedToFiat = !Boolean.FALSE.toString().equals(
                controller.getModel().getUserPreference(ExchangeModel.SHOW_WORLDCOIN_CONVERTED_TO_FIAT));
        showWorldcoinConvertedToFiat.setSelected(originalShowWorldcoinConvertedToFiat);

        String showDialogString = controller.getModel().getUserPreference(WorldcoinModel.OPEN_URI_SHOW_DIALOG);
        String useUriString = controller.getModel().getUserPreference(WorldcoinModel.OPEN_URI_USE_URI);
        ...
        if (fontNameString == null || "".equals(fontNameString)) {
            fontNameString = ColorAndFontConstants.WORLDCOIN_WALLET_DEFAULT_FONT_NAME;
        }
        originalFontName = fontNameString;

        int fontStyle = ColorAndFontConstants.WORLDCOIN_WALLET_DEFAULT_FONT_STYLE;
        ...
        int fontSize = ColorAndFontConstants.WORLDCOIN_WALLET_DEFAULT_FONT_SIZE;
    ...
    private JPanel createLanguagePanel(int stentWidth) {
        // Language radios.
        WorldcoinWalletTitledPanel languagePanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        JPanel stent = WorldcoinWalletTitledPanel.createStent(stentWidth);
        ...
        languagePanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);
    ...
    private JPanel createAppearancePanel(int stentWidth) {
        WorldcoinWalletTitledPanel appearancePanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        appearancePanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);

        WorldcoinWalletLabel fontNameLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontName"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 4;
        constraints.weightx = 0.3;
        ...
        fontNameTextLabel = new WorldcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 4;
        constraints.weightx = 0.3;
        ...
        WorldcoinWalletLabel fontStyleLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontStyle"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 5;
        constraints.weightx = 0.3;
        ...
        fontStyleTextLabel = new WorldcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 5;
        constraints.weightx = 0.3;
        ...
        WorldcoinWalletLabel fontSizeLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontSize"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 6;
        constraints.weightx = 0.3;
        ...
        fontSizeTextLabel = new WorldcoinWalletLabel("");
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 3;
        constraints.gridy = 6;
        constraints.weightx = 0.3;
        ...
        WorldcoinWalletButton fontChooserButton = new WorldcoinWalletButton(chooseFontAction, controller);
        ...
        constraints.gridwidth = 3;
        constraints.anchor = GridBagConstraints.LINE_START;
        appearancePanel.add(WorldcoinWalletTitledPanel.createStent(1, 30), constraints);

        WorldcoinWalletLabel lookAndFeelLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.lookAndFeel"));
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 1;
        constraints.gridy = 9;
        constraints.weightx = 0.3;
    ...
    private JPanel createTickerPanel(int stentWidth) {
        ...
        WorldcoinWalletTitledPanel tickerPanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        tickerPanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);

        String showTickerText = controller.getLocaliser().getString("worldcoinWalletFrame.ticker.show.text");
        ...
        exchangeInformationLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString(
                "showPreferencesPanel.ticker.exchangeInformation"));
        exchangeInformationLabel.setVisible(originalShowWorldcoinConvertedToFiat);

        showWorldcoinConvertedToFiat = new JCheckBox(controller.getLocaliser().getString(
                "showPreferencesPanel.ticker.showWorldcoinConvertedToFiat"));
        showWorldcoinConvertedToFiat.setOpaque(false);
        showWorldcoinConvertedToFiat.setFont(FontSizer.INSTANCE.getAdjustedDefaultFont());
        showWorldcoinConvertedToFiat.setSelected(originalShowWorldcoinConvertedToFiat);

        showWorldcoinConvertedToFiat.addItemListener(new ItemListener() {
            @Override
        ...
        constraints.gridwidth = 4;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(showWorldcoinConvertedToFiat, constraints);
        ...
        constraints.gridwidth = 3;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(WorldcoinWalletTitledPanel.createStent(1, 12), constraints);
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(WorldcoinWalletTitledPanel.createStent(1, 13), constraints);

        WorldcoinWalletTitledPanel.addLeftJustifiedTextAtIndent(controller.getLocaliser()
                .getString("showPreferencesPanel.ticker.firstRow"), 14, tickerPanel);

        WorldcoinWalletLabel exchangeLabel1 = new WorldcoinWalletLabel(controller.getLocaliser()
        ...
        oerMessageLabel1 = new WorldcoinWalletLabel("    " + controller.getLocaliser().getString("showPreferencesPanel.getAppId.label"));
        ...
        WorldcoinWalletLabel currencyLabel1 = new WorldcoinWalletLabel(controller.getLocaliser()
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(WorldcoinWalletTitledPanel.createStent(12, 12), constraints);
        ...
        constraints.anchor = GridBagConstraints.LINE_START;
        tickerPanel.add(
                WorldcoinWalletTitledPanel.createStent(fontMetrics.stringWidth(exchangeInformationLabel.getText()),
        ...
        exchangeLabel2 = new WorldcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.ticker.exchange"));
        ...
        oerMessageLabel2 = new WorldcoinWalletLabel("    " + controller.getLocaliser().getString("showPreferencesPanel.getAppId.label"));
        ...
        currencyLabel2 = new WorldcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.ticker.currency"));
        ...
        oerStent = WorldcoinWalletTitledPanel.createStent(12, 12);
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 1;
        ...
        oerApiCodeLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("showPreferencesPanel.oerLabel.text"));
        ...
        oerApiCodeTextField = new WorldcoinWalletTextField("", 25, controller);
        ...
        if (isBrowserSupported()) {
            getOerAppIdButton = new WorldcoinWalletButton(controller.getLocaliser().getString("showPreferencesPanel.getAppId.text"));
    ...
    private JPanel createBrowserIntegrationPanel(int stentWidth) {
        WorldcoinWalletTitledPanel browserIntegrationPanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
    ...
    private JPanel createButtonPanel() {
        ...
        helpButton.setText("");
        helpButton.setToolTipText(controller.getLocaliser().getString("worldcoinWalletFrame.helpMenuTooltip"));
        ...
        ShowPreferencesSubmitAction submitAction = new ShowPreferencesSubmitAction(this.worldcoinController, this.exchangeController, this,
                ImageLoader.createImageIcon(ImageLoader.PREFERENCES_ICON_FILE), mainFrame);
        WorldcoinWalletButton submitButton = new WorldcoinWalletButton(submitAction, controller);
        ...
        undoChangesButton = new WorldcoinWalletButton(undoChangesAction, controller);
    ...
    class LanguageComboBoxRenderer extends WorldcoinWalletLabel implements ListCellRenderer {
    ...
    @Override
    public boolean getPreviousShowWorldcoinConvertedToFiat() {
        return originalShowWorldcoinConvertedToFiat;
    }

    @Override
    public boolean getNewShowWorldcoinConvertedToFiat() {
        return showWorldcoinConvertedToFiat.isSelected();
    }
