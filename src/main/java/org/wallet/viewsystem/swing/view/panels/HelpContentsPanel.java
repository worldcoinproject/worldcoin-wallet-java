...
public class HelpContentsPanel extends JPanel implements Viewable {
    ...
    public static final String HELP_RECEIVING_URL = "help_receivingWorldcoin.html";
    public static final String HELP_RESET_BLOCKCHAIN_URL = "help_resetBlockchain.html";
    public static final String HELP_SENDING_URL = "help_sendingWorldcoin.html";
    ...
    public HelpContentsPanel(Controller controller, WorldcoinWalletFrame mainFrame) {
        ...
        final WorldcoinWalletFrame finalMainFrame = mainFrame;
    ...
    public static String createTooltipTextForMenuItem(String tooltip) {
        ...
        // Get property apple.laf.useScreenMenuBar - this is set in src/app-resources/WorldcoinWallet.app/info.plist
        String useScreenMenuBar = System.getProperty("apple.laf.useScreenMenuBar");
        String lookAndFeel = "" + WorldcoinWallet.getController().getModel().getUserPreference(CoreModel.LOOK_AND_FEEL);
    ...
    public static String createMultilineTooltipText(String[] toolTips) {
        ...
        FontSizer.INSTANCE.initialise(WorldcoinWallet.getController());
