...
public class WorldcoinWalletTextField extends JTextField {
    ...
    public WorldcoinWalletTextField(String text, int width, Controller controller) {
        this(text, width, controller, HEIGHT_DELTA);
    }

    public WorldcoinWalletTextField(String text, int width, Controller controller, int heightDelta) {
        super(text, width);
