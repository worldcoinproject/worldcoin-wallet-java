...
public class AddPasswordPanel extends JPanel implements Viewable, WalletBusyListener {
     ...
     */
    public AddPasswordPanel(WorldcoinController worldcoinController, WorldcoinWalletFrame mainFrame) {
    ...
    private JPanel createPasswordPanel(int stentWidth) {
        ...
        reminderLabel1 = new WorldcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder1"));
        ...
        reminderLabel2 = new WorldcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder2"));
        ...
        reminderLabel3 = new WorldcoinWalletLabel(controller.getLocaliser().getString("addPasswordPanel.reminder3"));
    ...
    private JPanel createButtonPanel() {
         ...
         */
        addPasswordSubmitAction = new AddPasswordSubmitAction(this.worldcoinController, this,
                ImageLoader.createImageIcon(ImageLoader.ADD_PASSWORD_ICON_FILE), passwordField, repeatPasswordField);
        WorldcoinWalletButton submitButton = new WorldcoinWalletButton(addPasswordSubmitAction, controller);
    ...
    public final void walletBusyChange(boolean newWalletIsBusy) {
        if (this.worldcoinController.getModel().getActiveWallet() != null) {
            if (this.worldcoinController.getModel().getActiveWallet().getEncryptionType() != EncryptionType.UNENCRYPTED) {
