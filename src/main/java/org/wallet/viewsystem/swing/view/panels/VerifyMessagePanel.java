...
public class VerifyMessagePanel extends JPanel implements Viewable, WalletBusyListener {
     ...
     */
    public VerifyMessagePanel(WorldcoinController worldcoinController, WorldcoinWalletFrame mainFrame) {
    ...
    private JPanel createInstructionsPanel(int stentWidth) {
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        instructionsPanel.add(WorldcoinWalletTitledPanel.createStent(stentWidth, ExportPrivateKeysPanel.STENT_HEIGHT), constraints);
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        instructionsPanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        instructionsPanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS),
                constraints);
    ...
    private JPanel createButtonPanel() {
        ...
        verifyMessageSubmitAction = new VerifyMessageSubmitAction(this.worldcoinController, mainFrame, this,
                ImageLoader.createImageIcon(ImageLoader.MESSAGE_VERIFY_ICON_FILE));
        WorldcoinWalletButton submitButton = new WorldcoinWalletButton(verifyMessageSubmitAction, controller);
