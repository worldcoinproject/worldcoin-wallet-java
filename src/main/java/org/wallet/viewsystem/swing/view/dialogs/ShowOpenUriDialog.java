 ...
 */
public class ShowOpenUriDialog extends WorldcoinWalletDialog implements Viewable, ShowUriDialogDataProvider {
     ...
     */
    public ShowOpenUriDialog(WorldcoinController worldcoinController, WorldcoinWalletFrame mainFrame) {
        super(mainFrame, worldcoinController.getLocaliser().getString("showOpenUriView.title"));
    ...
    private void initUI() {
        ...
        ShowOpenUriSubmitAction showOpenUriSubmitAction = new ShowOpenUriSubmitAction(mainFrame, this.worldcoinController, this, this);
    ...
    public Icon getViewIcon() {
        return ImageLoader.createImageIcon(ImageLoader.WORLDCOIN_WALLET_SMALL_ICON_FILE);
    }
    ...
    // WorldcoinFormDataProvider methods
    @Override
    public String getAddress() {
        return controller.getModel().getUserPreference(WorldcoinModel.OPEN_URI_ADDRESS);
    }

    @Override
    public String getLabel() {
        return controller.getModel().getUserPreference(WorldcoinModel.OPEN_URI_LABEL);
    }

    @Override
    public String getAmount() {
        return controller.getModel().getUserPreference(WorldcoinModel.OPEN_URI_AMOUNT);
    }
