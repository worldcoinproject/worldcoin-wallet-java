 ...
 * 
 */
public class WorldcoinWalletTitledPanel extends JPanel {
    ...
    public WorldcoinWalletTitledPanel(String title, ComponentOrientation componentOrientation) {
        ...
        Font titleFont = FontSizer.INSTANCE.getAdjustedDefaultFontWithDelta(ColorAndFontConstants.WORLDCOIN_WALLET_LARGE_FONT_INCREASE);
        ...
        titlePanel.add(WorldcoinWalletTitledPanel.getIndentPanel(preferredHeight), constraints);
        ...
        constraints.weighty = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        WorldcoinWalletLabel titleLabel = new WorldcoinWalletLabel(title, JLabel.LEFT);
    ...
    public static WorldcoinWalletLabel addLeftJustifiedTextAtIndent(String text, int row, JPanel panel) {
        GridBagConstraints constraints = new GridBagConstraints();
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 0;
        ...
        WorldcoinWalletLabel label = new WorldcoinWalletLabel(text);
