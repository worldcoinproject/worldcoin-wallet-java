...
public class HelpAboutPanel extends JPanel implements Viewable {
    ...
    private static final String WORLDCOIN_WALLET_URL = "https://wallet.org";
  ...
  /**
     ...
     */
    public HelpAboutPanel(Controller controller, WorldcoinWalletFrame mainFrame) {
        ...
        WorldcoinWalletLabel titleLabel = new WorldcoinWalletLabel("");
        ...
        constraints.weighty = 0.1;
        constraints.anchor = GridBagConstraints.CENTER;
        WorldcoinWalletLabel urlLabel = new WorldcoinWalletLabel(WORLDCOIN_WALLET_URL);
        ...
        constraints.weighty = 0.1;
        constraints.anchor = GridBagConstraints.CENTER;
        WorldcoinWalletLabel versionLabel = new WorldcoinWalletLabel(versionText);
