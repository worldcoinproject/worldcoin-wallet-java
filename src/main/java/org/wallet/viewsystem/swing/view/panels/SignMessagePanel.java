...
import org.wallet.viewsystem.swing.view.components.WorldcoinWalletTextArea;
...
public class SignMessagePanel extends JPanel implements Viewable, WalletBusyListener {
    ...
    private WorldcoinWalletLabel walletTextLabel;
    private JPasswordField walletPasswordField;
    private WorldcoinWalletLabel walletPasswordPromptLabel;

    private WorldcoinWalletTextArea addressTextArea;
    private WorldcoinWalletLabel addressLabel;
    
    private WorldcoinWalletTextArea messageTextArea;
    private WorldcoinWalletLabel messageLabel;
    
    private WorldcoinWalletTextArea signatureTextArea;
    private WorldcoinWalletLabel signatureLabel;
    
    private SignMessageSubmitAction signMessageSubmitAction;
    private WorldcoinWalletButton clearAllButton;
     ...
     */
    public SignMessagePanel(WorldcoinController worldcoinController, WorldcoinWalletFrame mainFrame) {
    ...
    private void initUI() {
        ...
        String[] keys = new String[] { "showExportPrivateKeysPanel.walletPasswordPrompt", "sendWorldcoinPanel.addressLabel",
        ...
        mainPanel.add(WorldcoinWalletTitledPanel.createStent(12, 12), constraints);
    ...
    private JPanel createInstructionsPanel(int stentWidth) {
        WorldcoinWalletTitledPanel instructionsPanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
    ...
    private JPanel createWalletPanel(int stentWidth) {
        ...
        walletTextLabel = WorldcoinWalletTitledPanel.addLeftJustifiedTextAtIndent(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        inputWalletPanel.add(WorldcoinWalletTitledPanel.createStent(stentWidth, (int) (ExportPrivateKeysPanel.STENT_HEIGHT * 0.5)), constraints);
    ...
    private JPanel createMessagePanel(int stentWidth) {
        WorldcoinWalletTitledPanel messagePanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString(
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        messagePanel.add(WorldcoinWalletTitledPanel.createStent(stentWidth, ExportPrivateKeysPanel.STENT_HEIGHT), constraints);
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        messagePanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);
        ...
        addressLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("sendWorldcoinPanel.addressLabel"));
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        messagePanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS),
                constraints);

        //addressTextArea = new WorldcoinWalletTextField("", 30, controller);
        JTextField aTextField = new JTextField();
        addressTextArea = new WorldcoinWalletTextArea("", 1, 30, controller);
        ...
        messageTextArea = new WorldcoinWalletTextArea("", AbstractTradePanel.PREFERRED_NUMBER_OF_LABEL_ROWS + 1, 20, controller);
        ...
        messageLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("verifyMessagePanel.message.text"));
        ...
        signatureLabel = new WorldcoinWalletLabel(controller.getLocaliser().getString("verifyMessagePanel.signature.text"));
        ...
        signatureTextArea = new WorldcoinWalletTextArea("", 2, 30, controller);
    ...
    private JPanel createButtonPanel() {
        ...
        signMessageSubmitAction = new SignMessageSubmitAction(this.worldcoinController, mainFrame, this,
                ImageLoader.createImageIcon(ImageLoader.MESSAGE_SIGN_ICON_FILE));
        WorldcoinWalletButton submitButton = new WorldcoinWalletButton(signMessageSubmitAction, controller);
        submitButton.applyComponentOrientation(ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
        buttonPanel.add(submitButton);
        
        clearAllButton = new WorldcoinWalletButton(controller.getLocaliser().getString("signMessagePanel.clearAll.text"));
    ...
    public void walletBusyChange(boolean newWalletIsBusy) {       
        ...
        if (this.worldcoinController.getModel().getActivePerWalletModelData().isBusy()) {
            ...
            signMessageSubmitAction.putValue(Action.SHORT_DESCRIPTION, HelpContentsPanel.createTooltipText(controller.getLocaliser().getString("worldcoinWalletSubmitAction.walletIsBusy",
    ...
    public WorldcoinWalletTextArea getMessageTextArea() {
        return messageTextArea;
    }

    public WorldcoinWalletTextArea getAddressTextArea() {
        return addressTextArea;
    }

    public WorldcoinWalletTextArea getSignatureTextArea() {
