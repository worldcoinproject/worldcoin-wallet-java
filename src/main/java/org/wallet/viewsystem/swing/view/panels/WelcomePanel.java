...
public class WelcomePanel extends JPanel implements Viewable {
     ...
     */
    public WelcomePanel(Controller controller, WorldcoinWalletFrame mainFrame) {
    ...
    private JPanel createWelcomePanel() {
        WorldcoinWalletTitledPanel welcomePanel = new WorldcoinWalletTitledPanel(controller.getLocaliser().getString("welcomePanel.title"), ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
        ...
        WorldcoinWalletTitledPanel.addLeftJustifiedTextAtIndent(" ", 3, welcomePanel);

        String paragraph1 = controller.getLocaliser().getString("welcomePanel.paragraph1");
        int height1 = calculateHeight(paragraph1);

        WorldcoinWalletTextArea paragraph1TextArea = new WorldcoinWalletTextArea(paragraph1, height1, TEXT_WIDTH, controller);
        ...
        WorldcoinWalletTextArea paragraph2TextArea = new WorldcoinWalletTextArea(paragraph2, height2, TEXT_WIDTH, controller);
        ...
        WorldcoinWalletTextArea paragraph25TextArea = new WorldcoinWalletTextArea(paragraph25, height25, TEXT_WIDTH, controller);
        ...
        WorldcoinWalletTextArea paragraph3TextArea = new WorldcoinWalletTextArea(paragraph3, height3, TEXT_WIDTH, controller);
        ...
        WorldcoinWalletTextArea paragraph4TextArea = new WorldcoinWalletTextArea(paragraph4, height4, TEXT_WIDTH, controller);
