...
public class ExportPrivateKeysPanel extends JPanel implements Viewable, WalletBusyListener {
    ...
    private WorldcoinWalletLabel doNotPasswordProtectWarningLabel;
     ...
     */
    public ExportPrivateKeysPanel(WorldcoinController worldcoinController, WorldcoinWalletFrame mainFrame) {
    ...
    private JPanel createFilenamePanel(int stentWidth) {
        ...
        constraints.gridwidth = 1;
        constraints.anchor = GridBagConstraints.CENTER;
        outputFilenamePanel.add(WorldcoinWalletTitledPanel.createStent(WorldcoinWalletTitledPanel.SEPARATION_BETWEEN_NAME_VALUE_PAIRS), constraints);
        ...
        WorldcoinWalletButton chooseOutputFilenameButton = new WorldcoinWalletButton(chooseFilenameButtonText);
    ...
    private JPanel createPasswordPanel(int stentWidth) {
        ...
        doNotPasswordProtectWarningLabel = new WorldcoinWalletLabel(" ");
    ...
    private JPanel createButtonPanel() {
         ...
         */
        exportPrivateKeySubmitAction = new ExportPrivateKeysSubmitAction(this.worldcoinController, this,
        ...
        WorldcoinWalletButton submitButton = new WorldcoinWalletButton(exportPrivateKeySubmitAction, controller);
    ...
    public void displayView(DisplayHint displayHint) {
        ...
        if (outputFilename == null || "".equals(outputFilename) || 
                (walletFilenameForChosenOutputFilename != null && !walletFilenameForChosenOutputFilename.equals(this.worldcoinController.getModel().getActiveWalletFilename()))) {
            outputFilename = createDefaultKeyFilename(this.worldcoinController.getModel().getActiveWalletFilename());
            walletFilenameForChosenOutputFilename = this.worldcoinController.getModel().getActiveWalletFilename();
    ...
    private void chooseFile() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (file != null) {
                ...
                if (!outputFilename.endsWith("." + WorldcoinModel.PRIVATE_KEY_FILE_EXTENSION)) {
                    outputFilename = outputFilename + "." + WorldcoinModel.PRIVATE_KEY_FILE_EXTENSION;
                }
    ...
    private String createDefaultKeyFilename(String walletFilename) {
        ...
        return stem + WorldcoinModel.PRIVATE_KEY_FILE_EXTENSION;
    }
    ...
    public void walletBusyChange(boolean newWalletIsBusy) {       
        ...
        if (this.worldcoinController.getModel().getActivePerWalletModelData().isBusy()) {
            ...
            exportPrivateKeySubmitAction.putValue(Action.SHORT_DESCRIPTION, HelpContentsPanel.createTooltipText(controller.getLocaliser().getString("worldcoinWalletSubmitAction.walletIsBusy",
