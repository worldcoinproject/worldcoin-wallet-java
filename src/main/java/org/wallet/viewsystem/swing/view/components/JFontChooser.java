 ...
 * release under MIT license - same as WorldcoinWallet
 ************************************************************/
...
public class JFontChooser extends JComponent {
    ...
    private WorldcoinWalletTextField fontFamilyTextField = null;
    private WorldcoinWalletTextField fontStyleTextField = null;
    private WorldcoinWalletTextField fontSizeTextField = null;
    ...
    public JFontChooser(Controller controller) {
        ...
        int minimumWidth = fontMetrics.stringWidth(WorldcoinWalletFrame.EXAMPLE_LONG_FIELD_TEXT) + WIDTH_DELTA;
    ...
    public JTextField getFontFamilyTextField() {
        if (fontFamilyTextField == null) {
            fontFamilyTextField = new WorldcoinWalletTextField("", 40, controller, 12);
    ...
    public JTextField getFontStyleTextField() {
        if (fontStyleTextField == null) {
            fontStyleTextField = new WorldcoinWalletTextField("", 40, controller, 12);
    ...
    public JTextField getFontSizeTextField() {
        if (fontSizeTextField == null) {
            fontSizeTextField = new WorldcoinWalletTextField("", 40, controller, 12);
    ...
    protected JDialog createDialog(Component parent) {
        ...
        WorldcoinWalletButton cancelButton = new WorldcoinWalletButton(cancelAction, controller);
    ...
    protected JPanel getFontFamilyPanel() {
        if (fontNamePanel == null) {
            ...
            WorldcoinWalletLabel label = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontName"));
    ...
    protected JPanel getFontStylePanel() {
        if (fontStylePanel == null) {
            ...
            WorldcoinWalletLabel label = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontStyle"));
            label.applyComponentOrientation(ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
            label.setHorizontalAlignment(JLabel.LEADING);
            label.setHorizontalTextPosition(JLabel.LEADING);
    ...
    protected JPanel getFontSizePanel() {
        if (fontSizePanel == null) {
            ...
            WorldcoinWalletLabel label = new WorldcoinWalletLabel(controller.getLocaliser().getString("fontChooser.fontSize"));
            label.applyComponentOrientation(ComponentOrientation.getOrientation(controller.getLocaliser().getLocale()));
