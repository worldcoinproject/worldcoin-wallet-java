...
public class WorldcoinWalletFormattedTextField extends JFormattedTextField {
    ...
    public WorldcoinWalletFormattedTextField(String text, int width, Controller controller, DecimalFormat format) {
        super(format);
