...
/**
 * This {@link Action} enables you to paste a swatch into the Send Worldcoin Panel
 */
public class PasteSwatchAction extends AbstractAction {
     ...
     */
    public PasteSwatchAction(WorldcoinController worldcoinController, AbstractTradePanel tradePanel, Icon icon) {
        super("", icon);
