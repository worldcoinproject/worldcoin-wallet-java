 ...
 */
public class ChangePasswordSubmitAction extends WorldcoinWalletSubmitAction implements WalletBusyListener {
     ...
     */
    public ChangePasswordSubmitAction(WorldcoinController worldcoinController, ChangePasswordPanel changePasswordPanel,
            ImageIcon icon, JPasswordField currentPassword, JPasswordField newPassword, JPasswordField repeatNewPassword) {
        super(worldcoinController, "changePasswordSubmitAction.text", "changePasswordSubmitAction.tooltip", "changePasswordSubmitAction.mnemonicKey", icon);
            ...
            if (!perWalletModelData.isBusy()) {
                ...
                if (decryptSuccess) {
                    try {
                        ...
                        fileHandler.savePerWalletModelData(super.worldcoinController.getModel().getActivePerWalletModelData(), true);
