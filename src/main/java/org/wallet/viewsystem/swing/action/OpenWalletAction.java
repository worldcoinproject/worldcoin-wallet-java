...
import org.wallet.network.WorldcoinWalletCheckpointManager;
...
public class OpenWalletAction extends AbstractAction {
     ...
     */
    public OpenWalletAction(WorldcoinController worldcoinController, ImageIcon icon, WorldcoinWalletFrame mainFrame) {
        super(worldcoinController.getLocaliser().getString("openWalletAction.text"), icon);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (fileChooser == null) {
                ...
                if (controller.getModel() != null && this.worldcoinController.getModel().getActiveWalletFilename() != null) {
                ...
                if (file != null) {
                    if (!file.isDirectory()) {
                        ...
                        if (controller != null && controller.getModel() != null) {
                            List<WalletData> perWalletDataModels = this.worldcoinController.getModel().getPerWalletModelDataList();
                                    ...
                                    while(iterator.hasNext()) {
                                        ...
                                        if (perWalletModelData != null && perWalletModelData.getWalletFilename() != null) {
                                            if (perWalletModelData.getWalletFilename().equals(selectedWalletFilename)) {
                                                ...
                                                this.worldcoinController.getModel().setActiveWalletByFilename(selectedWalletFilename);
                                                ...
                                                if ((perWalletModelData.getWalletFilename() + "." + BackupManager.FILE_ENCRYPTED_WALLET_SUFFIX).equals(selectedWalletFilename)) {
                                                    walletIsAlreadyOpen = true;
                                                    this.worldcoinController.getModel().setActiveWalletByFilename(perWalletModelData.getWalletFilename());
                                                    controller.fireDataChangedUpdateNow();
                                                    break;
                                                }    
                                            }
                        ...
                        if (!walletIsAlreadyOpen) {
                            ...
                            Message openMessage = new Message(controller.getLocaliser().getString("worldcoinWallet.openingWallet", new Object[]{selectedWalletFilename}));
    ...
    private CharSequence getPasswordFromUser() {
        ...
        WorldcoinWalletLabel passwordLabel = new WorldcoinWalletLabel("");
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
            ...
            protected Boolean doInBackground() throws Exception {
                try {
                    ...
                    WalletData perWalletModelData = worldcoinController.addWalletFromFilename(selectedWalletFilenameFinal);
 
                    log.debug("Setting active wallet for file '" + selectedWalletFilenameFinal + "'.");
                    worldcoinController.getModel().setActiveWalletByFilename(selectedWalletFilenameFinal);
                    ...
                    message = controller.getLocaliser().getString("worldcoinWallet.openingWalletIsDone", new Object[]{selectedWalletFilenameFinal});
            ...
            protected void done() {
                try {
                    ...
                    if (wasSuccessful) {
                        ...
                        WalletData perWalletModelData = worldcoinController.getModel().getActivePerWalletModelData();
                        ...
                        if (lastBlockSeenHeight > 0 && currentChainHeight > 0) {
                            if (lastBlockSeenHeight >= currentChainHeight) {
                                // WorldcoinWallet is at or ahead of current chain - but check there isnt a replay at the moment.
                            ...
                            if (mainFrame != null) {
                                ...
                                if (walletListPanel != null) {
                                    ...
                                    if (singleWalletPanel != null) {
                                        singleWalletPanel.setSyncMessage(controller.getLocaliser().getString("worldcoinWalletDownloadListener.downloadingTextShort"), Message.NOT_RELEVANT_PERCENTAGE_COMPLETE);
                                    }
                                }
                            }
                        ...
                        WalletData loopData = worldcoinController.getModel().getPerWalletModelDataByWalletFilename(selectedWalletFilenameFinal);
                        if (loopData != null) {
