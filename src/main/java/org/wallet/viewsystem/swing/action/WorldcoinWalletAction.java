 ...
 */
public class WorldcoinWalletAction extends AbstractAction {
     ...
     */
    public WorldcoinWalletAction(Controller controller, String imagePath, String textKey, String tooltipKey, String mnemonicKey, View viewToDisplay) {
