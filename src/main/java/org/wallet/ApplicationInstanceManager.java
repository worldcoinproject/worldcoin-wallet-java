...
public final class ApplicationInstanceManager {
    ...
    /**
     * WorldcoinWallet port number, as specified in
     * http://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers
     */
    public static final int WORLDCOIN_WALLET_NETWORK_SOCKET = 11043;

    /**
     * Multibit message start - must end with newline
     */
    public static final String MESSAGE_START = "$$WorldcoinWalletMessageStart$$\n";
    ...
    public static boolean registerInstance(String rawURI) {
        ...
        // return false
        try {
            final ServerSocket socket = new ServerSocket(WORLDCOIN_WALLET_NETWORK_SOCKET, 10, InetAddress.getByAddress(new byte[]{127, 0,
                0, 1}));
            log.debug("Listening for application instances on socket " + WORLDCOIN_WALLET_NETWORK_SOCKET);
            ...
            try {
                Socket clientSocket = new Socket(InetAddress.getByAddress(new byte[]{127, 0, 0, 1}), WORLDCOIN_WALLET_NETWORK_SOCKET);
