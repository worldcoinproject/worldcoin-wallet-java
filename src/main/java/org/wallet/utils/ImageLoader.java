...
public final class ImageLoader {
    ...
    public static final String WORLDCOIN_WALLET_128_ICON_FILE = "/images/worldcoin128.png";
    public static final String WORLDCOIN_WALLET_ICON_FILE = "/images/worldcoin.png";
    public static final String WORLDCOIN_WALLET_SMALL_ICON_FILE = "/images/worldcoin-small.png";
    ...
    public static final String RECEIVE_WORLDCOIN_ICON_FILE = "/images/receiveIn.png";
    ...
    public static final String SEND_WORLDCOIN_ICON_FILE = "/images/sendOut.png";
    ...
    public static ImageIcon createImageIcon(String path) {
        ...
        java.net.URL imgURL = WorldcoinWalletFrame.class.getResource(path);
        if (imgURL != null) {
            return new ImageIcon(imgURL);
        } else {
            log.error("org.wallet.WorldcoinWalletFrame#createImageIcon: Could not find file: " + path);
            return null;
        }
    }
}
