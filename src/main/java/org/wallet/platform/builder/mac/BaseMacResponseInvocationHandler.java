 ...
 */
package org.wallet.platform.builder.mac;

import java.lang.reflect.InvocationHandler;
import java.lang.reflect.Method;
import java.lang.reflect.Proxy;

import org.wallet.platform.handler.GenericHandler;
import org.wallet.platform.listener.GenericEvent;
 ...
 * <ul>
 * <li><code>H</code>: The generic handler class (e.g. {@link org.wallet.platform.builder.mac.QuitHandlerInvocationHandler}</li>
 * <li><code>E</code>: The generic event class (e.g. {@link org.wallet.platform.listener.GenericQuitEvent}</li>
 * <li><code>R</code>: The generic response class (e.g. {@link org.wallet.platform.listener.GenericQuitResponse}</li>
 * </ul>
 *
 * @since 0.3.0
 */
public abstract class BaseMacResponseInvocationHandler<H extends GenericHandler, E extends GenericEvent, R extends GenericEvent> implements InvocationHandler {
    ...
    /**
     * <p>Create a proxy instance of {@link org.wallet.platform.listener.GenericEvent}
